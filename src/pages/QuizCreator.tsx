...
export function QuizCreator() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      // 3. If published successfully, delete the draft if it exists
      if (draftId) {
        ...
        >
          ...
          <div className="space-y-6">
            <div>
              ...
              <ImageUploader onUploadSuccess={setQuizImage} className="h-48" />
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="md:col-span-1">
                  ...
                  <ImageUploader onUploadSuccess={(url) => updateQuestion(qIndex, 'imageUrl', url)} className="h-32" />
                </div>
